...
window.jwplayer = function(t) {
	...
	var r = n(18),
		...
		T = function(t, e, n, r) {
			...
			if (null == t && (t = []), p && t.reduce === p) return r && (e = Z(e, r)), i ? t.reduce(e, n) : t.reduce(e);
	...
	var r = n(29),
		...
		u = function() {
			var t = "//cdn.jsdelivr.net/gh/blblank/jwplayer/8.24.0/";
	...
	var r = "8.24.0+commercial_v8-24-0.484.commercial.3d7a417.hlsjs..hlsjsalt..jwplayer.ef4821b.dai.1f98a0b.freewheel.a260fcd.googima.b98d228.headerbidding.fc3f7f0.vast.d9489b6.analytics.d52963c.gapro.141397a"
}, function(t, e, n) {
	"use strict";
	var r = n(0),
		i = n(18),
	...
	function w(t, e) {
		if (l || (l = new g(document).on("interaction")), !t.handlers.init && !t.handlers.select) {
			var n = t.el;
			C(t, e, "blur", (function() {
	...
	var M = function(t) {
		var e, n;
		if (t ? "string" == typeof t ? (e = I(t)) || (n = document.getElementById(t)) : "number" == typeof t ? e = v.a[t] : t.nodeType && (e = I((n = t).id || n.getAttribute("data-jwplayer-id"))) : e = v.a[0], e) return e;
		if (n) {
			var r = new F(n);
			return v.a.push(r), r
		}
	...
	function X(t) {
		var e = {};
		Y(this, t, t, e), Y(this, t, F.prototype, e)
	}
	...
	function J(t, e) {
		var n = {
			reason: !("play" === t || "seek" === t || "pause" === t) && Object(Q.a)() ? "interaction" : "external"
		};
		switch (t) {
			case "play":
			case "pause":
	...
	var nt = function(t) {
		var e = N(t);
		return e.uniqueId ? e._publicApi || (e._publicApi = new X(e)) : e
	};
	...
	}, r._iframe = window.top !== window.self, r._original = r._iframe, e.a = r
}, function(t, e, n) {
	"use strict";
	var r = n(0),
		i = n(3),
	...
	function v(t) {
		return h || (h = function(t) {
			...
			if (e && r && i) return o = n.e(8).then(function(t) {
				n(169);
				var e = n(73).default;
				return f.a.controls = n(71).default, Object(l.a)(n(296).default), e
			...
			if (e && r) return n.e(7).then(function(t) {
				n(169);
				var e = n(73).default;
				return f.a.controls = n(71).default, e
		...
		return window.location !== window.parent.location && /isAMP/.test(document.location.search) ? function(t, e) {
			return function(t, e) {
				return n.e(1).then(function(r) {
					return new(0, n(317).default)(e).setup(t)
	...
	var L = function(t) {
			...
			this.start = function(n) {
				var r = A(t, n),
					i = Promise.all([v(t), r, T(t), E(t), M(t), I(t)]),
	...
	var q = function() {
			...
			return e.getAllItems = function() {
				...
				return this.items.reduce((function(e, n) {
					var r = D[t.namespace + "." + n];
					return r && (e[n] = "captions" !== n ? Object(B.serialize)(r) : JSON.parse(r)), e
				}), {})
			}, e.track = function(t) {
				var e = this;
				this.items.forEach((function(n) {
					t.on("change:" + n, (function(t, r) {
						try {
							"captions" === n && (r = JSON.stringify(r)), D[e.namespace + "." + n] = r
						} catch (t) {
	...
	Object(r.j)(Y.prototype, {
		...
		init: function(t, e) {
			var n = this,
				i = this.modelShim,
				u = new q("jwplayer", ["volume", "mute", "captionLabel", "captions", "bandwidthEstimate", "bitrateSelection", "qualityLabel", "enableShortcuts"]),
				a = u && u.getAllItems();
			...
			var l = Object(Q.b)();
			i.get("backgroundLoading") || (l = Object(K.a)(l.getPrimedElement(), l));
			var f = this.primeUi = new X.a(Object(X.b)(this.originalContainer)).once("gesture", (function() {
				l.prime(), n.preload(), f.destroy()
			}));
			return i.on("change:errorEvent", G), this.setup.start(e).then((function(t) {
				var o = t.core;
				if (!o) throw Object(d.y)(null, d.v);
				if (n.setup) {
					n.on(b.ub, $), t.warnings.forEach((function(t) {
						n.trigger(b.ub, t)
					}));
					...
					var s = n._model;
					return i.off("change:errorEvent", G), s.on("change:errorEvent", G), u.track(s), n.updatePlaylist(s.get("playlist"), s.get("feedData")).catch((function(t) {
				...
				n.setup && function(t, e, n) {
					Promise.resolve().then((function() {
						...
						if (!o) {
							var u = Object(W.a)(t, r);
							W.a.cloneIcon && u.querySelector(".jw-icon").appendChild(W.a.cloneIcon("error")), J(t, u)
						}
		...
		playerDestroy: function() {
			this.destroy && this.destroy(), this.apiQueue && this.apiQueue.destroy(), this.setup && this.setup.destroy(), this.primeUi && this.primeUi.destroy(), this.currentContainer !== this.originalContainer && J(this, this.originalContainer), this.off(), this._events = this._model = this.modelShim = this.apiQueue = this.primeUi = this.setup = null
		},
		getContainer: function() {
	...
	function g(t, e) {
		...
		var n = "",
			r = {
				...
				//googima: e ? __REPO__GOOGIMA_NVMP__ : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.9.1/googima.js",
